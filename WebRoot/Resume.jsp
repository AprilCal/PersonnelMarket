...
欢java 开发，具备一定的软件分析、设计、开发和应用能力，拥有较强的学习能力与团队精神，能够很快的适应工作环境。" />
<title>简历</title>
...
<div class="n_dispage_jm">
    ...
    <!--基本信息-->
        ...
        <div class="msgDiv positonDiv resume_add_area resume_sort" id="resume_msg">
            ...
            <input class="baseBorder resume_msg resume_lang_age" for-key="age" value="年龄" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '年龄';}">
          </div>
            ...
            <input class="resume_msg baseBorder resume_lang_address" for-key="address" value="联系地址" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '联系地址';}">
          </div>
            ...
            <input class="resume_msg baseBorder resume_lang_mobile" for-key="mobile" value="联系电话" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '联系电话';}">
          </div>
            ...
            <input class="resume_msg baseBorder resume_lang_email" for-key="email" value="电子邮箱" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '电子邮箱';}">
          </div>
                </div>
        ...
        <div class="nameDiv positonDiv" id="resume_name">
                  <h1>
              <input type="text" name="user" value="姓名" onfocus="if(this.value=='姓名'){this.value = '';}" onblur="if (this.value == '') {this.value = '姓名';}">
        ...
        <div class="eduDiv baseItem positonDiv resume_item resume_add_area resume_sort resume_notice" notice-key="edu" id="resume_edu" for-key="edu">
            ...
            <dt> <a class="resume_icon_diy icon wbdfont" for-id="edu" style="font-size:none"></a> <span>
              <div class="resume_lang_edu">教育经历</div>
